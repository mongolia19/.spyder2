...
def train_word2vec_gensim(sentences):
    ...
    # 构建模型
    if os.path.exists(word_embedding_model):
...
if __name__ == "__main__":
    sentences = MySentences('/home/idroid/wikidata/split')  # a memory-friendly iterator
    ...
    # w_sim = word_similarity_by_wordvec_gensim('father', 'fathers', word_model)
